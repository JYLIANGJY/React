...
var FetchData = function FetchData(props) {
  return __jsx("div", null, __jsx("h3", null, "\u83B7\u53D6\u670D\u52A1\u7AEF\u7684\u6570\u636E"), __jsx("ul", null, props.productList.map(function (item) {
    return __jsx("li", {
      key: item.id
    }, item.title);
  })));
...
FetchData.getInitalProps = function _callee() {
  var res, data;
...
//# sourceMappingURL=fetch-data.js.20a715ef55bdaaabdfdf.hot-update.js.map