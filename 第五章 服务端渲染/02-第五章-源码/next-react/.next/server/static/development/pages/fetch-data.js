...
/* harmony default export */ __webpack_exports__["default"] = (class extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  static async getInitialProps() {
    let res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()(" http://localhost:8081/api/getProductList");
    let data = await res.json();
    return {
  ...
  render() {
    return __jsx("div", null, __jsx("ul", null, this.props.productList.map(item => __jsx("li", {
      key: item.id
    }, item.title))));
  }
...
module.exports = __webpack_require__(/*! E:\D\博学谷\React课程\视频录制\案例\next-react\pages\fetch-data\index.js */"./pages/fetch-data/index.js");
